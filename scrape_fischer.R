...
fischer <- read_html("data/fischer_final.html")
table <- fischer %>% 
    html_element("table") 
...
saveRDS(donations_clean, "output/fischer/donations_all.rds")
write.csv(donations_clean, "output/fischer/donations_all.csv", row.names = FALSE)

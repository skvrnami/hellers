...
nerudova <- read_html("data/nerudova_final.html")
table <- nerudova %>% 
    html_element("table") 
...
saveRDS(donations_clean, "output/nerudova/donations_all.rds")
write.csv(donations_clean, "output/nerudova/donations_all.csv", row.names = FALSE)
